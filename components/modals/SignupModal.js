      ...
      >
        ...
        >
          <div className="w-[90%] mt-8 flex flex-col">
            <button className="bg-white text-black w-full font-bold text-lg-2 rounded-md">
              Sign In as Guest
            </button>
            ...
            <input
              ...
              type={"password"}
            />
            <button className="bg-white text-black w-full font-bold text-lg-2 mt-8 rounded-md">
              Create Account
            </button>
          </div>
        </div>
